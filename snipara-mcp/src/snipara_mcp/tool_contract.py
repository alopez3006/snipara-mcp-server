"""Generated Snipara MCP tool contract.

This module mirrors src/mcp/tool_defs.py so the standalone snipara-mcp
package can expose the hosted tool surface without importing backend modules.
"""
